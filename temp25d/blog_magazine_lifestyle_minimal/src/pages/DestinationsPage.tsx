...
export const DestinationsPage: React.FC = () => {
  // Filter for travel/greece category
  const destinationStories = stories.filter(
    (s) => s.category === 'greece' || s.category === 'travel'
  );
    ...
    <div className="flex-grow max-w-5xl mx-auto w-full px-6 py-12 md:py-20 space-y-12">
      <header className="text-center space-y-4">
        ...
        <p className="text-sm text-text/60 max-w-md mx-auto tracking-wider leading-relaxed">
          Meditative journeys through hidden archipelagos, ancient stone pathways, and coastal architectural sanctuaries.
        </p>
