  ...
  if (!article) {
    return (
      <div className="max-w-2xl mx-auto px-6 py-20 text-center font-heading">
        <h2 className="text-2xl font-bold text-white mb-4">LOG_NOT_FOUND</h2>
        <p className="text-text/60 mb-6">The requested build log entry could not be located in the telemetry archives.</p>
        <Link to="/articles" className="border border-primary text-primary px-4 py-2 hover:bg-primary hover:text-bg transition-all font-bold">
          RETURN_TO_INDEX
        </Link>
      </div>
    );
