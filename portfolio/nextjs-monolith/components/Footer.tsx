        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="mt-3 text-text-secondary text-sm leading-relaxed">
              ...
              technologies. Building products that make a difference.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="text-sm text-text-secondary hover:text-primary transition">
                  Home
                </Link>
              </li>
              <li>
                <Link href="/projects" className="text-sm text-text-secondary hover:text-primary transition">
                  Projects
                </Link>
              </li>
              <li>
                <Link href="/about" className="text-sm text-text-secondary hover:text-primary transition">
                  About
                </Link>
              </li>
              <li>
                <Link href="/contact" className="text-sm text-text-secondary hover:text-primary transition">
                  Contact
                </Link>
              </li>
            </ul>
